...
def make_prediction(model, device, valid_dl,test_dataset):
...
yolo_model_loaded = pickle.load(open(os.path.join(os.path.abspath(os.path.dirname(sys.argv[0])),'data/XXXXX.pkl'), "rb"))
